...
*/
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
       ...
       //  mReceiver.start();13.58.183.35
          locstat=0;
            strtime=0;
            stopStatus=1;
            Log.e("Service Started", "oo");
            Urlf="http://172.16.72.235:8000/api/update_location_and_parameters/";
    ...
    public void onDestroy()
    {
        ...
        super.onDestroy();
            ...
            Log.e("Service Stopped",".ONDESTROY.");
...
{
    Log.e("ONLOCATIONCHANGED ERROR",e.toString());
}
